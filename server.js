...
const taskRoutes = require("./server/routes/tasks"); // import the task routes
...
app.use("/api/tasks", taskRoutes); // use the task routes for '/api/tasks'
...
server.listen(port, function () {
  console.log("Task Manager API running on localhost: " + port);
});
